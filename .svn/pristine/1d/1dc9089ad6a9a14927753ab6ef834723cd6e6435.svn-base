                    ...
                    <div class="profile-header mb-3">
                        ...
                        <div class="divider-custom-icon">
                            <c:if test="${sessionScope.login.userProfile == null}">
                                <img src="<c:url value='/assets/images/non.png'/>" id="userProfile" class="rounded-circle img-thumbnail shadow-sm" width="200px" style="cursor: pointer;">
                            </c:if>
                            <c:if test="${sessionScope.login.userProfile != null}">
                                <img src="<c:url value='${sessionScope.login.userProfile}'/>" id="userProfile" class="rounded-circle img-thumbnail shadow-sm" width="200px" style="cursor: pointer;">
                            </c:if>
