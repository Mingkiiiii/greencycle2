		...
		<div class="container" style="margin-top: 100px;">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					<form action="<c:url value="/csWriteDo" />" method="post" onsubmit="return fn_check()">
						<!-- title input-->
						<div class="mb-3">
							<label for="csTitle">제목</label>
							<input class="form-control" id="csTitle" name="csTitle" type="text" />
						</div>
						...
						<div class="mb-3">
							...
							<input class="form-control" id="csPw" name="csPw" type="password" />
						</div>
						...
						<!-- content input-->
						<div class="mb-3">
							<textarea class="form-control" name="csContent" id="csContent" style="height: 20rem"></textarea>
						</div>
						<!-- Submit Button-->
						<button class="btn btn-primary btn-xl float-right"" type="submit">등록</button>
					</form>
				</div>
			</div>
		</div>
