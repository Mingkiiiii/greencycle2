...
<body class="back_ground_cont">
    <div class="container">
        <div class="character-selection-content">
            <img src="<c:url value='/assets/images/left_icon.png' />" alt="Left Arrow" class="arrow-icon left" onclick="slideLeft()"> 
            <img src="<c:url value='/assets/images/right_icon.png' />" alt="Right Arrow" class="arrow-icon right" onclick="slideRight()">
                ...
                <c:if test="${damainfoNo == null}">
                    <form id="characterForm" action="<c:url value='/gameMain' />" method="post">
                        ...
                        <div class="character-slider" id="damainfoChar">
                            <label class="character-label" data-character="bear_white">
                                <img src="<c:url value='/assets/images/bear_white.png' />" alt="Bear White">
                                <input type="radio" name="selectedCharacter" value="bear_white">
                                <span>Bear White</span>
                            </label>
                            <label class="character-label" data-character="bear_brown">
                                <img src="<c:url value='/assets/images/bear_brown.png' />" alt="Bear Brown">
                                <input type="radio" name="selectedCharacter" value="bear_brown">
                                <span>Bear Brown</span>
                            </label>
                            <label class="character-label" data-character="cat_white">
                                <img src="<c:url value='/assets/images/cat_white.png' />" alt="Cat White">
                                <input type="radio" name="selectedCharacter" value="cat_white">
                                <span>Cat White</span>
                            </label>
                            <label class="character-label" data-character="dog_brown">
                                <img src="<c:url value='/assets/images/dog_brown.png' />" alt="Dog Brown">
                                <input type="radio" name="selectedCharacter" value="dog_brown">
                                <span>Dog Brown</span>
                            </label>
                            <label class="character-label" data-character="dog_white">
                                <img src="<c:url value='/assets/images/dog_white.png' />" alt="Dog White">
                                <input type="radio" name="selectedCharacter" value="dog_white">
                                <span>Dog White</span>
                            </label>
                        </div>
